...
const Header = () => {
  ...
  return (
    <header className="bg-gray-50 bg-opacity-80 backdrop-blur-md fixed top-0 left-0 right-0 z-50">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-20">
          <a 
            href="#"
            className="text-xl hover:text-white hover:bg-gray-700 transition-colors rounded-md p-2"
          >
